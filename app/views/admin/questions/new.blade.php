...
<!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="#"><i class="fa fa-question-circle"></i> Nueva Ciudad</a></li>
          </ol>
        </section>
        <div class="row">
          <div class="col-xs-12 col-md-10 col-md-offset-1 formulario">
              <div class="box box-success">
                ...
                <div class="box-body chat" id="chat-box">
                  ...
                  @endif
                  <form class="new-user-form row" method="POST" action="{{ URL::to('administracion/ciudades/nueva/enviar') }}" enctype="multipart/form-data"> 
