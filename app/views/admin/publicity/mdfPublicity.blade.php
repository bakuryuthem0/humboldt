    ...
    <div class="col-xs-12 col-md-8 col-md-offset-2 formulario">
        <div class="box box-success">
          ...
          <div class="box-body chat" id="chat-box">
            ...
            @endif
            <form class="new-user-form" method="POST" action="{{ URL::to('administracion/publicidad/modificar/'.$p->id.'/enviar') }}" enctype="multipart/form-data"> 
              <div class="col-xs-12 formulario">
               ...
               <input type="text" name="title" class="form-control title" placeholder="Titulo" value="{{ $p->title }}">
               @if($errors->has('title'))
              ...
              <div class="col-xs-12 col-md-6 formulario">
               ...
               <input type="url" name="url" class="form-control" placeholder="http://midominio.com" value="{{ $p->url }}">
               @if($errors->has('url'))
              ...
              <div class="col-xs-12 col-md-6 formulario">
               ...
               <select class="form-control" name="ubication">
                <option value="1" @if($p->ubication == 1) selected @endif>Página Principal</option>
                <option value="2" @if($p->ubication == 2) selected @endif>Página de Busqueda</option>
                <option value="3" @if($p->ubication == 3) selected @endif>Página de Publicación</option>
               </select>
              ...
              <div class="col-xs-12 col-md-6 formulario">
               ...
               <input type="text" name="start_date" class="form-control datepicker date-start" placeholder="DD-MM-YYYY" value="{{ date('m/d/Y',strtotime($p->start_date)) }}">
              ...
              <div class="col-xs-12 col-md-6 formulario">
               ...
               <input type="text" name="end_date" class="form-control datepicker date-end" placeholder="DD-MM-YYYY" value="{{ date('m/d/Y',strtotime($p->end_date)) }}">
              ...
              <div class="col-xs-12 formulario">
               ...
               <output class="outpost"><a href="{{ asset('images/publicity/'.$p->image) }}" class="fancybox" data-fancybox="{{ ucfirst($p->title) }}"><img src="{{ asset('images/publicity/'.$p->image) }}" class="center-block publication-image"></a></output>
               @if($errors->has('image'))
