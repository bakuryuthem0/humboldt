            ...
            <div class="col-md-3">
              ...
              <div class="box box-primary avatar-box">
                <div class="box-body box-profile" style="padding:0;">
                  <img class="profile-user-img img-responsive img-circle profile-picture center-block" src="{{ asset('templates/admin/dist/img/'.Auth::user()->avatar) }}" alt="User profile picture">
                </div><!-- /.box-body -->
                <div class="box-body avatar-change hidden img-circle img-responsive"  data-toggle="modal" href='#uploadImage'>
                  <p class="text-center">Click aquí para cambiar su avatar</p>
                </div>
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  <div class="tab-pane  @if(!Session::has('act') || Session::get('act') == 'perfil') active @endif" id="settings">
                    ...
                    @endif
                    <form class="form-horizontal" method="POST" action="{{ URL::to('administracion/usuario/perfil/enviar') }}" enctype="multipart/form-data">
                   ...
                   <div class="tab-pane @if(Session::has('act') && Session::get('act') == 'pass') active @endif" id="pass" >
                    ...
                    @endif
                    <form class="form-horizontal" method="POST" action="{{ URL::to('administracion/usuario/perfil/cambiar-contrasena/enviar') }}">
                      <div class="form-group">
...
{{ HTML::script('templates/admin/dropzone.js') }}
